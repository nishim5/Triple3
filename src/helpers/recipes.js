...
export default {
  ...
  2: {
    ...
    instructions: [
      ...
      "Pan-toast until crispy"
    ]
  },

  3: {
    name: "Garlic Butter (or Olive Oil) Pasta",
    ingredients: [
      "Pasta",
      "Butter or olive oil",
      "Garlic",
  ...
  4: {
    name: "Microwave Sweet Potato Bowl",
    ingredients: [
      "Sweet potato",
      "Salt & pepper"
    ],
